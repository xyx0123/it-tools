...
import { tool as gnssTileidToGeohash } from './gnss-tileid-to-geohash';
...
export const toolsByCategory: ToolCategory[] = [
  ...
  {
    name: 'Network',
    components: [ipv4SubnetCalculator, ipv4AddressConverter, ipv4RangeExpander, macAddressLookup, macAddressGenerator, ipv6UlaGenerator, gnssTileidToGeohash],
  },
  {
    name: 'Math',
